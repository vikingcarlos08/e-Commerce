            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li id="shopL" class="tab"><a href="single-product.html">Category</a></li>
                        <li id="shopL" class="tab"><a href="#">Others</a></li>
                        <li id="shopL" class="tab"><a href="#">Contact</a></li>
                    </ul>
                </div>  
            </div>
        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <form action="" class="cart">
                                        ...
                                        <button class="add_to_cart_button" type="submit">Upload</button>
                                    </form>   
